...
Spec.configure do |config|
  ...
  describe '投稿のテスト' do
      ...
      describe 'top画面(top_path)のテスト' do
          before  do
            visit top_path 
          end
          context '表示の確認' do
  ...
  describe '詳細画面のテスト' do
      ...
      context 'リンクの遷移先の確認' do
          it '編集の遷移先は編集画面か' do
              ...
              edit_link.click
              expect(current_path).to eq('/list/' + list_id.to_i + '/edit')
          end
      end
  ...
  describe '編集画面のテスト' do
      ...
      context '更新処理に関するテスト' do
          it '更新後のリダイレクト先は正しいか' do
              ...
              expect(page).to have_current_path list_path(list.i)
          end
      end
  end
